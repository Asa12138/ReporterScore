...
ReporterScore: an R package for Reporter Score-based Microbial Enrichment Analysis.
...
Use `up_level_KO` can upgrade to specific level in one of "pathway", "module", "level1", "level2", "level3", "module1", "module2", "module3".
